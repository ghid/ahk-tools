...
Main:
	...
	op.Add(new OptParser.Boolean("q", "quiet", _q, "Run quiet and return result as exit code"))
	op.Add(new OptParser.Boolean("r", "", _r, "Reverse operation: convert long-time to timestamp"))
	op.Add(new OptParser.Group("Adjustments:"))
	op.Add(new OptParser.String("y", "", _adj_years, "adujst-years", "Adjust time +/- years", OptParser.OPT_ARG,, 0))
	op.Add(new OptParser.String("m", "", _adj_month, "adujst-month", "Adjust time +/- month", OptParser.OPT_ARG,, 0))
	op.Add(new OptParser.String("d", "", _adj_days, "adujst-days", "Adjust time +/- days", OptParser.OPT_ARG,, 0))
	op.Add(new OptParser.String("H", "", _adj_hours, "adujst-hours", "Adjust time +/- hours", OptParser.OPT_ARG,, 0))
	op.Add(new OptParser.String("M", "", _adj_minutes, "adujst-minutes", "Adjust time +/- minutes", OptParser.OPT_ARG,, 0))
	op.Add(new OptParser.String("S", "", _adj_seconds, "adujst-seconds", "Adjust time +/- seconds", OptParser.OPT_ARG,, 0))
